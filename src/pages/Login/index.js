                ...
                <CardAuth>
                    ...
                    <Form>
                        ...
                        <FormGroup>
                            ...
                            <Input name="password" type="password" minLength="6" onChange={this.handleChange} placeholder="Digite aqui a sua senha" onKeyPress={this.handleKeyPress} />
                        </FormGroup>
                        <SendButton id="send_button" type="button" onClick={this.handleSubmitLogin}>ENVIAR</SendButton>
                    </Form>
                </CardAuth>
            </Container>
    }

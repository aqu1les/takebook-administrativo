...
export default function Users() {
    ...
    async function updateUser(e) {
        ...
        if (!action || action.error)
            return notifyError(action.error || 'Erro no servidor.');
                        ...
                        <div className="row">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    value={modalUser.address_zip_code || ''}
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    name="address_street"
                                    value={modalUser.address_street || ''}
                                    onChange={handleChange}
                                />
                            </div>
                        </div>
                        <div className="row">
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    name="address_number"
                                    value={modalUser.address_number || ''}
                                    onChange={handleChange}
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    value={modalUser.address_neighborhood || ''}
                                    onChange={handleChange}
                                />
                            </div>
                        </div>
